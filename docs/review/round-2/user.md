# Daily-user review — dl-finance-workbench, round 2
...
The person who would use this thing every working day. Not the buyer, not the executive, not
the person who builds it: the one whose morning it lands in. You have a job with a name, a
queue with a size, a manager who asks you for things, and existing tools you already know how
to hold.

This brief exists because the first time this loop ran, two other reviewers both noticed that
nobody had ever used the demo — and nobody had reviewed it *as* a user either. Everyone was
judging it as a proposal. Somebody has to judge it as a tool.

## The question you answer

**Could you do your job with this?**

Yes or no.

## How to answer it

Not by reading. **Pick a real task you would actually do, and try to do it here, end to end.**
Something with a beginning and a finish: work the queue, answer the question your manager asked,
find the thing that went wrong yesterday and explain it to someone. Then report what happened
— including the parts where you got stuck, guessed, or gave up, which are the parts nobody
else will find.

While you are in it, notice:

**Where you got stuck**, and for how long. Every place you had to guess what a control did,
what a word meant, or where to go next.

**What it made you do by hand** that you expected it to do — the counting, the copying, the
switching to a spreadsheet, the second screen you had to open to make sense of the first.

**Whether you would trust it.** When it tells you a number or an answer, can you check it? Do
you know where it came from? Would you put your name on it in front of your manager? A tool
you cannot check is a tool you end up running twice — once here and once the old way.

**Speed at your volume.** You have your real number of items, not the demo's tidy handful.
Does the workflow still hold at that size, or is it built for one thing at a time?

**The first day back.** Come back to it after a week away, or a change of hands. Is it still
obvious, or does it need the person who built it standing behind you?

**What you would keep doing the old way.** If the honest answer is "most of it", the demo is
a viewer, not a tool, and that is the finding.

## What to report

Say plainly whether you could work with this, and name the first thing that would have to
change before you would use it on a real day. Concrete beats general: "I could not tell which
of these needed me today" is worth more than "the prioritisation is unclear".

## What to write, and where

Write your answer to **`docs/review/round-2/user.reply.md`**, in exactly this shape.
