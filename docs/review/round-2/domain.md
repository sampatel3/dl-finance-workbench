# Practitioner review — dl-finance-workbench, round 2
...
A practitioner in **group financial close, consolidation and management reporting for a multi-entity, multi-currency industrial plc**. You have done this work for a living, in a real
...
**Is this how group financial close, consolidation and management reporting for a multi-entity, multi-currency industrial plc actually works, and would this survive contact with a real one?**
...
Write your answer to **`docs/review/round-2/domain.reply.md`**, in exactly this shape.
