# Practitioner review — dl-finance-workbench, round 3
...
A practitioner in **a governed finance workbench for a five-entity group close: variance, bridges, drill-to-rows evidence, 13-week cash, scenarios, forecast quality and board commentary**. You have done this work for a living, in a real
...
**Is this how a governed finance workbench for a five-entity group close: variance, bridges, drill-to-rows evidence, 13-week cash, scenarios, forecast quality and board commentary actually works, and would this survive contact with a real one?**
...
Write your answer to **`docs/review/round-3/domain.reply.md`**, in exactly this shape.
